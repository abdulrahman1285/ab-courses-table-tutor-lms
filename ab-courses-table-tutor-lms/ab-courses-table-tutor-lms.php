 ...
 * Plugin URI:  https://github.com/abdulrahmanbarakat/ab-courses-table-tutor-lms
 ...
 * Text Domain: ab-courses-table-tutor-lms
...
add_action( 'admin_menu', function () {
    add_options_page(
        __( 'LMS Courses Table Settings', 'ab-courses-table-tutor-lms' ),
        __( 'Courses Table', 'ab-courses-table-tutor-lms' ),
        'manage_options',
        'abct-settings',
...
function abct_render_settings_page() {
    ...
    <div class="wrap" dir="rtl">
        <h1 style="margin-bottom:20px;">⚙️ <?php esc_html_e( 'LMS Courses Table Settings', 'ab-courses-table-tutor-lms' ); ?></h1>

        <?php if ( $updated ) : ?>
            <div class="notice notice-success is-dismissible"><p>✅ <?php esc_html_e( 'Settings saved successfully!', 'ab-courses-table-tutor-lms' ); ?></p></div>
        <?php endif; ?>
        ...
        <form method="post" action="options.php">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;max-width:980px;">
                ...
                <div style="background:#fff;border:1px solid #ddd;border-radius:8px;padding:20px;">
                    <h2 style="margin-top:0;font-size:15px;border-bottom:1px solid #eee;padding-bottom:8px;">
                        🎨 <?php esc_html_e( 'Display Settings', 'ab-courses-table-tutor-lms' ); ?>
                    </h2>
                    <table class="form-table" style="margin:0;">
                        <tr>
                            <th style="width:170px;"><?php esc_html_e( 'Rows per page', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Sort by', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td>
                                <select name="abct_settings[sort_by]">
                                    <option value="date"       <?php selected( abct_opt('sort_by','date'), 'date' ); ?>><?php esc_html_e( 'Publish date', 'ab-courses-table-tutor-lms' ); ?></option>
                                    <option value="title"      <?php selected( abct_opt('sort_by','date'), 'title' ); ?>><?php esc_html_e( 'Name', 'ab-courses-table-tutor-lms' ); ?></option>
                                    <option value="meta_value" <?php selected( abct_opt('sort_by','date'), 'meta_value' ); ?>><?php esc_html_e( 'Start date', 'ab-courses-table-tutor-lms' ); ?></option>
                                </select>
                                <select name="abct_settings[sort_order]">
                                    <option value="DESC" <?php selected( abct_opt('sort_order','DESC'), 'DESC' ); ?>><?php esc_html_e( 'Descending', 'ab-courses-table-tutor-lms' ); ?></option>
                                    <option value="ASC"  <?php selected( abct_opt('sort_order','DESC'), 'ASC' ); ?>><?php esc_html_e( 'Ascending', 'ab-courses-table-tutor-lms' ); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show search', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_search]" value="1" <?php checked( abct_opt('show_search','1'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show online / offline toggle', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_mode_toggle]" value="1" <?php checked( abct_opt('show_mode_toggle','1'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show category tabs', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_categories]" value="1" <?php checked( abct_opt('show_categories','1'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show available seats', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_seats]" value="1" <?php checked( abct_opt('show_seats','0'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show price', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_price]" value="1" <?php checked( abct_opt('show_price','0'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show enrolled students', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_students]" value="1" <?php checked( abct_opt('show_students','0'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show course level', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_level]" value="1" <?php checked( abct_opt('show_level','0'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Show course duration', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[show_duration]" value="1" <?php checked( abct_opt('show_duration','0'), '1' ); ?> /> <?php esc_html_e( 'Yes', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( '"Course full" label', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><input type="text" name="abct_settings[no_seats_label]" value="<?php echo esc_attr( abct_opt('no_seats_label') ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'Course is full', 'ab-courses-table-tutor-lms' ); ?>" /></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Primary color', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><input type="color" name="abct_settings[primary_color]" value="<?php echo esc_attr( abct_opt('primary_color','#1A5276') ); ?>" /></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Accent color', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><input type="color" name="abct_settings[accent_color]" value="<?php echo esc_attr( abct_opt('accent_color','#B7950B') ); ?>" /></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Registration page URL', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><input type="url" name="abct_settings[registration_page]" value="<?php echo esc_attr( abct_opt('registration_page') ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'Leave empty to use the course URL', 'ab-courses-table-tutor-lms' ); ?>" /></td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="background:#fff;border:1px solid #ddd;border-radius:8px;padding:20px;">
                    <h2 style="margin-top:0;font-size:15px;border-bottom:1px solid #eee;padding-bottom:8px;">
                        🔧 <?php esc_html_e( 'Tutor LMS Settings', 'ab-courses-table-tutor-lms' ); ?>
                    </h2>
                    <table class="form-table" style="margin:0;">
                        <tr>
                            <th style="width:170px;"><?php esc_html_e( 'Category taxonomy', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td>
                                ...
                                <p class="description"><?php esc_html_e( 'Default:', 'ab-courses-table-tutor-lms' ); ?> <code>course-category</code></p>
                            </td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Start date meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Start time meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'End time meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Delivery mode meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td>
                                ...
                                <p class="description"><?php esc_html_e( 'Expected values:', 'ab-courses-table-tutor-lms' ); ?> <code>online</code> / <code>offline</code></p>
                            </td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Max students meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Price meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Enrolled students meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Level meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                        ...
                        <tr>
                            <th><?php esc_html_e( 'Duration meta key', 'ab-courses-table-tutor-lms' ); ?></th>
                    ...
                    <h2 style="font-size:15px;border-bottom:1px solid #eee;padding-bottom:8px;margin-top:20px;">
                        ⚡ <?php esc_html_e( 'Cache', 'ab-courses-table-tutor-lms' ); ?>
                    </h2>
                    <table class="form-table" style="margin:0;">
                        <tr>
                            <th style="width:170px;"><?php esc_html_e( 'Enable cache', 'ab-courses-table-tutor-lms' ); ?></th>
                            <td><label><input type="checkbox" name="abct_settings[enable_cache]" value="1" <?php checked( abct_opt('enable_cache','0'), '1' ); ?> /> <?php esc_html_e( 'Yes (faster page load)', 'ab-courses-table-tutor-lms' ); ?></label></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e( 'Cache duration (hours)', 'ab-courses-table-tutor-lms' ); ?></th>
            ...
            <div style="background:#f0f6fc;border:1px solid #c3d9ed;border-radius:8px;padding:16px;max-width:980px;margin-top:20px;">
                <strong>📋 <?php esc_html_e( 'Shortcode:', 'ab-courses-table-tutor-lms' ); ?></strong>
                <code style="background:#fff;padding:4px 10px;border-radius:4px;margin-right:8px;">[abct_courses_table]</code>
            </div>

            <?php submit_button( __( 'Save Settings', 'ab-courses-table-tutor-lms' ), 'primary', 'submit', true, ['style'=>'margin-top:16px;'] ); ?>
        </form>
    </div>
    <?php
}
...
add_action( 'wp_enqueue_scripts', function () {
    ...
    wp_localize_script( 'abct-script', 'abctI18n', [
        'noResults'  => __( 'No matching courses found', 'ab-courses-table-tutor-lms' ),
        'of'         => __( 'of', 'ab-courses-table-tutor-lms' ),
        'prev'       => __( 'Previous', 'ab-courses-table-tutor-lms' ),
        'next'       => __( 'Next', 'ab-courses-table-tutor-lms' ),
    ] );
} );
...
add_shortcode( 'abct_courses_table', function ( $atts ) {
    $atts = shortcode_atts( [
        ...
        'no_seats_label'    => abct_opt( 'no_seats_label',    __( 'Course is full', 'ab-courses-table-tutor-lms' ) ),
    ...
    if ( ! function_exists( 'tutor' ) && ! defined( 'TUTOR_VERSION' ) ) {
        return '<p style="color:red;">' . esc_html__( 'Tutor LMS is not active or not installed.', 'ab-courses-table-tutor-lms' ) . '</p>';
    }
...
function abct_get_courses( $atts ) {
    ...
    foreach ( $query->posts as $post ) {
        ...
        $level_map = [
            'beginner'     => __( 'Beginner', 'ab-courses-table-tutor-lms' ),
            'intermediate' => __( 'Intermediate', 'ab-courses-table-tutor-lms' ),
            'expert'       => __( 'Advanced', 'ab-courses-table-tutor-lms' ),
        ];
        ...
        $courses[] = [
            ...
            'date'       => $day_ar . ' ' . __( 'corresponding to', 'ab-courses-table-tutor-lms' ) . ' ' . $start_date,
            'date_raw'   => $start_date,
            'time'       => $time_str,
...
function abct_day_arabic( $date_str ) {
    $days = [
        'Saturday'  => __( 'Saturday',  'ab-courses-table-tutor-lms' ),
        'Sunday'    => __( 'Sunday',    'ab-courses-table-tutor-lms' ),
        'Monday'    => __( 'Monday',    'ab-courses-table-tutor-lms' ),
        'Tuesday'   => __( 'Tuesday',   'ab-courses-table-tutor-lms' ),
        'Wednesday' => __( 'Wednesday', 'ab-courses-table-tutor-lms' ),
        'Thursday'  => __( 'Thursday',  'ab-courses-table-tutor-lms' ),
        'Friday'    => __( 'Friday',    'ab-courses-table-tutor-lms' ),
    ];
